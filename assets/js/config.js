/* =============================================================
   CONFIGURAÇÃO DO HOTSITE — Parceria AMM + IPGC
   -------------------------------------------------------------
   PONTO ÚNICO DE EDIÇÃO.
   Altere os valores abaixo para atualizar todos os botões de CTA,
   contatos e links do site de uma só vez. Não é necessário mexer
   no HTML.
   ============================================================= */
window.SITE_CONFIG = {
